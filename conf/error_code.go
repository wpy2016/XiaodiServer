...
const (
	...
	NOT_SEND_REWARD_CAN_NOT_UPDATE = 3013
	NOT_SEND_REWARD_CAN_NOT_UPDATE_MSG = "已领取悬赏不允许删除"

	NOT_OWNER_REWARD_CAN_NOT_UPDATE = 3014
	NOT_OWNER_REWARD_CAN_NOT_UPDATE_MSG = "不允许删除非本人的悬赏"
